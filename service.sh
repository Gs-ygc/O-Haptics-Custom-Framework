...
boot
rm -rf /data/odm/etc/gs2/efmap.txt.last
...
WATCHED_FILE="/storage/emulated/0/Android/gs_vibrator/efmap.txt"
EXEC_SCRIPT="${BASEDIR}/efmap_update.sh"

while true; do /bin/inotifyd "$EXEC_SCRIPT" "$WATCHED_FILE":Mc; done
